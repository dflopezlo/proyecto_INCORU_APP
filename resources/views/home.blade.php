			...
			<div class="row w-100">
					<div class="col-md-3">
						<div class="card border-info mx-sm-1 p-3">
							...
							<div class="text-info text-center mt-3"><h4>Pedidos</h4></div>
					...
					<div class="col-md-3">
						<div class="card border-success mx-sm-1 p-3">
							...
							<div class="text-success text-center mt-3"><h4>Fincas</h4></div>
							<div class="text-success text-center mt-2"><h1>3</h1></div>
						</div>
					</div>
					<div class="col-md-3">
